        ...
        <div>
          ...
          <div class="flex items-center gap-2 mt-2">
             <span class="relative flex h-2 w-2">
               @if(dataService.dataSource() === 'API') {
                 <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
               }
               <span class="relative inline-flex rounded-full h-2 w-2" [class.bg-green-500]="dataService.dataSource() === 'API'" [class.bg-stone-400]="dataService.dataSource() !== 'API'"></span>
             </span>
